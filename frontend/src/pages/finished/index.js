...
function Finished() {
    ...
    useEffect(() => {
        api.get('/consult/profile/conclude').then(response => {setConsults(response.data)});
    });
    ...
    return (
        <div className="container-edit">
            <header>
                ...
                <h1 className="title-finished">Consultas já concluídas</h1>

                <Link to="/home" className="button button-logout-finished">VOLTAR</Link>
            </header>
